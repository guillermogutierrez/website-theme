...
<div id="wrapper">
	...
	<footer class="container-fluid-1280" id="footer" role="contentinfo">
		...
		<#assign VOID = freeMarkerPortletPreferences.setValue("groupId", "20152") />
		<#assign VOID = freeMarkerPortletPreferences.setValue("articleId", "65151") />

		<@liferay_portlet["runtime"] defaultPreferences="${freeMarkerPortletPreferences}" portletProviderAction=portletProviderAction.VIEW instanceId="anynameyoucangive" portletName="com_liferay_journal_content_web_portlet_JournalContentPortlet" />
		${freeMarkerPortletPreferences.reset()}
	</footer>
</div>
